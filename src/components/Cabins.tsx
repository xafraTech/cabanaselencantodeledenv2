...
const Cabins = () => {
  const cabins = [
    {
      ...
      features: ["Jacuzzi", "Malla catamarán", "Desayuno incluido", "Wi-Fi", "Proyector de películas", "Reproductor de música", "Barril asador"],
      images: [
        "/Colibri 3.jpg",
        "/colibri 1.jpg",
        "/Colibri 5.jpg",
  ...
  const handleContactAdvisor = () => {
    const message = "Hola! Me gustaría obtener más información sobre las cabañas disponibles y sus servicios.";
